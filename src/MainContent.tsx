            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
              ...
              >
                ...
                <p className="text-base mt-6 mb-20 text-slate-700">
                  An <span className="text-sky-300">Employee Experience</span>{" "}
                  and <span className="text-sky-300 ">Engagement Platform</span>{" "}
                  designed to{" "}
                ...
                <div className="flex flex-wrap items-center justify-center  md:justify-start gap-5">
                  <div className="py-3 px-6 rounded border border-red-500 font-semibold text-white bg-red-500 hover:shadow-lg hover:shadow-red-500/50 focus:outline focus:outline-red-500/50 transition-all duration-500">
                    Learn More
                  </div>
                </div>
              </div>
